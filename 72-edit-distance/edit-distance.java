...
class Solution {  // Renamed from TUF to Solution
    // Function to calculate the minimum edit distance between two strings
    static int minDistance(String S1, String S2) {  // Renamed from editDistance to minDistance
        int n = S1.length();
        int m = S2.length();
    ...
    public static void main(String args[]) {
        ...
        System.out.println("The minimum number of operations required is: " +
                minDistance(s1, s2));  // Calling minDistance instead of editDistance
    }
}
